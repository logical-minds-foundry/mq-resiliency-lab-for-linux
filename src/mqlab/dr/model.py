...
class MessageFacts:
    ...
    seq: int
    uuid: str
    app_confirmed: bool  # firm received its reply at/before cutover
    svc_received: int  # Watcher: number of times DTCC received this message
    svc_replied: bool  # Watcher: DTCC produced a reply
